...
const Products = () => {
  ...
  return (
    <section className="products flex" style={{color: "#462576" ,padding:"0px 55px"}}>
      {/* array.map */}
      {data.map((item) => {
        return (
          <article title={item.name} key={item.id} className="card" dir="rtl">
            <a href="/pages/product-details.html">
            <img width={266}  src={item.image} alt="" style={{ backgroundColor: "#FF6542" }} /> 
            </a>
            <div style={{ width: "266px" }} className="content">
              ...
              <p style={{color: "#888",fontSize: "14px",marginBottom: "8px",fontStyle: "italic", }}>
                المستوى: {item.level}
              </p>
